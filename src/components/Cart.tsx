      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <motion.aside
            ...
            className="relative flex h-full w-full max-w-md flex-col overflow-y-auto border-l-4 border-double border-accent-gold bg-surface p-6 sm:p-8"
          >
              ...
              <div className="mt-6 flex flex-1 flex-col">
                      ...
                      <li key={line.item.id} className="flex items-center justify-between gap-3 border-b border-accent-gold/40 pb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="h-7 w-7 rounded-sm border border-muted font-body font-bold text-foreground transition-transform duration-200 hover:scale-110 hover:border-primary"
                          >
                            −
                          </button>
                ...
                <div className="mt-6 border-t-2 border-accent-gold pt-4">
                  ...
                  <button
                    ...
                    className="mt-4 w-full rounded-sm border border-accent-gold bg-primary px-6 py-3 font-body text-lg font-bold uppercase tracking-wide text-surface transition-transform duration-200 hover:scale-105 hover:bg-secondary disabled:pointer-events-none disabled:opacity-40"
                  >
                    Continuar
                  </button>
                </div>
            ...
            {step === "checkout" && (
              <form onSubmit={handleConfirm} className="mt-6 flex flex-1 flex-col">
                ...
                <div className="mt-6 border-t-2 border-accent-gold pt-4">
                  ...
                  <button
                    type="submit"
                    className="mt-4 w-full rounded-sm border border-accent-gold bg-primary px-6 py-3 font-body text-lg font-bold uppercase tracking-wide text-surface transition-transform duration-200 hover:scale-105 hover:bg-secondary"
                  >
                    Confirmar pedido
                  </button>
                  <button
                    ...
                    className="mt-2 w-full rounded-sm border-2 border-primary px-6 py-2 font-body text-sm font-bold uppercase tracking-wide text-primary transition-colors duration-200 hover:bg-primary hover:text-surface"
                  >
                    Volver al carrito
                  </button>
                </div>
            ...
            {step === "confirmation" && (
              ...
              >
                ...
                <button
                  ...
                  className="mt-6 w-full rounded-sm border-2 border-primary px-6 py-3 font-body text-lg font-bold uppercase tracking-wide text-primary transition-colors duration-200 hover:bg-primary hover:text-surface"
                >
                  Hacer otro pedido
                </button>
              </motion.div>
